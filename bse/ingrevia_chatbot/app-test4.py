...
def load_css():
    ...
    <style>
        ...
        .stButton > button:not([kind="primary"]):not(.main-action-btn) {{
            background: linear-gradient(135deg, #EAF0CA 0%, #F2EFDE 100%) !important;
            color: #2d4a35 !important;
            border: 1px solid #d9e0b8 !important;
            box-shadow: 0 2px 8px rgba(234, 240, 202, 0.25), 0 1px 3px rgba(45, 74, 53, 0.08) !important;
            font-weight: 500 !important;
        }}
        
        .stButton > button:not([kind="primary"]):not(.main-action-btn):hover {{
            background: linear-gradient(135deg, #e5ebbc 0%, #ede9d6 100%) !important;
            color: #1a3d25 !important;
            border-color: #d1d8a8 !important;
            transform: translateY(-1px) !important;
            box-shadow: 0 4px 12px rgba(229, 235, 188, 0.35), 0 2px 6px rgba(26, 61, 37, 0.12) !important;
        }}
        
        .stButton > button:not([kind="primary"]):not(.main-action-btn):active {{
            background: linear-gradient(135deg, #dfe5b0 0%, #e7e3ce 100%) !important;
            color: #1a3d25 !important;
            transform: translateY(0px) !important;
            box-shadow: 0 1px 4px rgba(223, 229, 176, 0.3), inset 0 1px 2px rgba(26, 61, 37, 0.1) !important;
        }}

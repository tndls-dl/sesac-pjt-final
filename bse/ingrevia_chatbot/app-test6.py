...
def load_css():
    ...
    <style>
        ...
        /* 선택 단계 버튼들을 깔끔한 크림 톤으로 */
        .stButton > button:not([kind="primary"]):not(.main-action-btn) {{
            background: linear-gradient(135deg, #FFF8EB 0%, #FEFAE0 100%) !important;
            color: #2d4a35 !important;
            border: 1px solid #F0E8D8 !important;
            box-shadow: 0 2px 8px rgba(255, 248, 235, 0.4), 0 1px 3px rgba(45, 74, 53, 0.08) !important;
            font-weight: 500 !important;
        }}
        
        .stButton > button:not([kind="primary"]):not(.main-action-btn):hover {{
            background: linear-gradient(135deg, #FAF3E0 0%, #F9F5DC 100%) !important;
            color: #1a3d25 !important;
            border-color: #EBE3D3 !important;
            transform: translateY(-1px) !important;
            box-shadow: 0 4px 12px rgba(250, 243, 224, 0.5), 0 2px 6px rgba(26, 61, 37, 0.12) !important;
        }}
        
        .stButton > button:not([kind="primary"]):not(.main-action-btn):active {{
            background: linear-gradient(135deg, #F5EEDB 0%, #F4F0D8 100%) !important;
            color: #1a3d25 !important;
            transform: translateY(0px) !important;
            box-shadow: 0 1px 4px rgba(245, 238, 219, 0.4), inset 0 1px 2px rgba(26, 61, 37, 0.1) !important;
        }}
